...
//This is how we make our reducer state and reducer dispatch
...
// [readOnlyLocalStorageData, functionToUpdateLocalStorage] = useLocalStorage(keyInLocalStorage, defaultDataIfKeyIsNotFound)
    const [persistentData, setPersistentData] = useLocalStorage('notes', JSON.stringify(initialNotesData));
