...
const notesReducer = (previousState, instructions) => {
	...
	switch (instructions.type){
		...
		case "update":
			...
			let targetNoteIndex = stateEditable.find(globalSpecificNote => {
				return globalSpecificNote.id === instructions.updateNote.id;
			})
			stateEditable[targetNoteIndex] = instructions.updateNote;
			break;
		case "delete":
